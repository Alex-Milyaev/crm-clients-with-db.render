// Функция создания header которую экспортируем в основной файл со скриптами

export const createClientsHeader = () => {

    // Создаем DOM элементы header
    ...
    // Присваиваем созданным элементам header классы и необходимые атрибуты
    ...
    // Вкладываем созданные элементы в header согласно разметке
    ...
    // Из этой функции возвращаем созданный header
    return header;
}
